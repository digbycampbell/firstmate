...
description: >-
  Self-update a running firstmate and its registered secondmates to the latest from origin.
  Use when the captain invokes /updatefirstmate ("update firstmate", "pull the latest firstmate").
user-invocable: true
metadata:
  internal: true
---
