...
description: >-
  Agent-only decision procedure for resolving a matched crew-dispatch profile array from quota-axi output, ranking by spendPriority after three orthogonal gates.
