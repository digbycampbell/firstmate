...
name: ahoy
description: >-
  Recap visible session events and unanswered captain decisions when the captain explicitly invokes /ahoy, falling back to Bearings when /ahoy is the session's first real captain message.
user-invocable: true
metadata:
  internal: true
---
