...
worker_run_with_timeout() { # <job-dir> <seconds> <command> [args...]
  ...
  local group_tmp group_start_tmp rc tmp deadline next_check attempt now timed_out=0 cancelled=0
  WORKER_PREEMPTED=0
  shift 2
  ...
  # cancellation and preemption check stays on SECONDS because it tolerates a
  # second of drift.
