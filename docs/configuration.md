...
FM_HERDR_PRESENTATION_LOCK_WAIT_SECS=300  # herdr-only: seconds a spawn waits for a live holder of the presentation-order lock before refusing as a deadlock (bin/backends/herdr.sh fm_backend_herdr_presentation_order_lock_wait)
