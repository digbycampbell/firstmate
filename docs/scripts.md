...
| `fm-test-sandbox-lib.sh` | Single owner of the suite's containment boundary: cleared `FM_*` namespace, private `TMPDIR`, and a shim refusing the real `treehouse` binary |
